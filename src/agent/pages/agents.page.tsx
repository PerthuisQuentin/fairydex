...
import AgentsByFaction from '../components/agents-by-faction.component';
    ...
    return (
        <div className="w-full flex flex-col justify-center">
            ...
            <div className="px-2 my-2 flex flex-row flex-wrap gap-4 justify-center">
                ...
                <TextButton
                    className="italic"
                    selected={viewMode === ViewMode.Faction}
                    onClick={() => setViewMode(ViewMode.Faction)}
                >
                    By Faction
                </TextButton>
            </div>
            <div className='my-4 w-full flex justify-center'>
                ...
                {viewMode === ViewMode.Faction && (
                    <div className='w-full px-4 lg:max-w-4xl xl:max-w-6xl'>
                        <AgentsByFaction />
                    </div>
                )}
            </div>
